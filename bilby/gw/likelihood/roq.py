...
class ROQGravitationalWaveTransient(GravitationalWaveTransient):
    ...
    def save_weights(self, filename, format=None):
        """
        Save ROQ weights into a single hdf5 file.
        ...
        format : (str, deprecated)
            This option is deprecated, only :code:`hdf5`
        ...
        if format is not None:
            logger.warning(
                "The format option is deprecated, only hdf5 is supported.")
        elif format != 'hdf5':
    ...
    def load_weights(self, filename, format=None):
        """
        Load ROQ weights from an :code:`hdf5` file.
        ...
        filename : str
            The name of the file to save the weights to.
        format : (str, deprecated)
            This option is deprecated, only :code:`hdf5` file formats
            are supported.
